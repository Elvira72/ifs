  ...
  function parseRows(text, f) {
    ...
    function token() {
      ...
      if (text.charCodeAt(j2) === QUOTE) {
        ...
        if ((i = I2) >= N2)
          eof = true;
        else if ((c3 = text.charCodeAt(I2++)) === NEWLINE)
          eol = true;
        else if (c3 === RETURN) {
          eol = true;
      ...
      while (I2 < N2) {
        if ((c3 = text.charCodeAt(i = I2++)) === NEWLINE)
          eol = true;
        else if (c3 === RETURN) {
          eol = true;
          if (text.charCodeAt(I2) === NEWLINE)
...
function find_default(x3, y3, radius) {
  ...
  while (q2 = quads.pop()) {
    if (!(node = q2.node) || (x12 = q2.x0) > x32 || (y1 = q2.y0) > y32 || (x22 = q2.x1) < x02 || (y22 = q2.y1) < y0)
      continue;
    if (node.length) {
...
var binomial_default = function sourceRandomBinomial(source) {
  var G2 = geometric_default.source(source), B4 = beta_default.source(source);
  function randomBinomial(n, p) {
    ...
    return function() {
      ...
      while (nn * pp > 16 && nn * (1 - pp) > 16) {
        var i = Math.floor((nn + 1) * pp), y3 = B4(i, nn - i + 1)();
        if (y3 <= pp) {
          acc += i;
          nn -= i;
          pp = (pp - y3) / (1 - y3);
...
var poisson_default = function sourceRandomPoisson(source) {
  var G2 = gamma_default.source(source), B4 = binomial_default.source(source);
...
var K2 = typeof navigator < "u" && navigator.userAgent.includes("Macintosh");
...
function Se(e) {
  ...
  if ((i == null ? void 0 : i.length) === 1) {
    ...
    const s2 = ordinal(i);
    t.color = (l) => s2(`${l.state.path}`);
  }
  if (o) {
    const s2 = t.color || P.color;
    t.color = (l) => (l = {
      ...l,
      state: {
        ...l.state,
  ...
  return ["duration", "maxWidth", "initialExpandLevel"].forEach((s2) => {
    const l = n[s2];
    typeof l == "number" && (t[s2] = l);
  }), ["zoom", "pan"].forEach((s2) => {
    const l = n[s2];
    l != null && (t[s2] = !!l);
  }), t;
...
function $(e, t) {
  return Array.isArray(e) ? Xt(e.map((n) => $(n, t))) : B3(e, t);
}
function B3(e, t = zt) {
  ...
  if (vt(e)) {
    ...
    if (!t.isSvg && i === "svg" && (t = Object.assign({}, t, {
      ...
      let c3 = t;
      t.isSvg && i === "foreignObject" && (c3 = Object.assign({}, c3, {
        isSvg: false
      }));
      const s2 = $(o.children, c3);
      s2 != null && I(n, s2);
    }
    const {
      ref: a2
    } = o;
    return typeof a2 == "function" && a2(n), n;
  }
...
function Rt(e) {
  var t = this, n, i = [t], o, a2, c3;
  do
    for (n = i.reverse(), i = []; t = n.pop(); )
      if (e(t), o = t.children, o)
        for (a2 = 0, c3 = o.length; a2 < c3; ++a2)
          i.push(o[a2]);
  while (i.length);
  return this;
}
...
function Mt(e) {
  for (var t = this, n = [t], i = [], o, a2, c3; t = n.pop(); )
...
function F(e, t) {
  var n = new N(e), i = +e.value && (n.value = e.value), o, a2 = [n], c3, s2, l, p;
  for (t == null && (t = It); o = a2.pop(); )
    if (i && (o.value = +o.data.value), (s2 = t(o.data)) && (p = s2.length))
      for (o.children = new Array(p), l = p - 1; l >= 0; --l)
        a2.push(c3 = o.children[l] = new N(s2[l])), c3.parent = o, c3.depth = o.depth + 1;
...
function q(e) {
  ...
  function i(s2) {
    const l = c3(a2(), s2, (p) => p.children);
    return l.update(), l.data;
  }
  function o() {
    const s2 = n("nodeSize"), l = n("spacing");
  ...
  function a2() {
    const s2 = o(), l = n("nodeSize"), p = n("spacing");
  ...
  function c3(s2, l, p) {
    const h = (u4, g) => {
      ...
      const f = p(u4) || [];
      return x3.children = f.length === 0 ? null : f.map((y3) => h(y3, x3)), x3.children && Object.assign(x3, x3.children.reduce(
        (y3, m) => ({
          height: Math.max(y3.height, m.height + 1),
          length: y3.length + m.length
        }),
        x3
      )), x3;
    };
  ...
  return Object.assign(i, {
    nodeSize(s2) {
      return arguments.length ? (t.nodeSize = s2, i) : t.nodeSize;
    },
    spacing(s2) {
      return arguments.length ? (t.spacing = s2, i) : t.spacing;
    },
    children(s2) {
      return arguments.length ? (t.children = s2, i) : t.children;
    },
    hierarchy(s2, l) {
    ...
    dump(s2) {
      const l = n("nodeSize"), p = (h) => (u4) => {
        const g = h + "  ", x3 = h + "    ", { x: f, y: y3 } = u4, m = l(u4), k2 = u4.children || [], v2 = k2.length === 0 ? " " : `,${g}children: [${x3}${k2.map(p(x3)).join(x3)}${g}],${h}`;
        return `{ size: [${m.join(", ")}],${g}x: ${f}, y: ${y3}${v2}},`;
      };
      return p(`
`)(s2);
    }
...
q.version = oe;
var J = (e, t = 0) => (e.y = t, (e.children || []).reduce((n, i) => {
  const [o, a2] = n;
  J(i, e.y + e.ySize);
  const c3 = (o === 0 ? i.lExt : i.rExt).bottom;
  o !== 0 && le(e, o, a2);
  const s2 = ge(c3, o, a2);
  return [o + 1, s2];
}, [0, null]), ae(e), me(e), e);
...
var ae = (e) => {
  (e.children || []).reduce((t, n) => {
    const [i, o] = t, a2 = i + n.shift, c3 = o + a2 + n.change;
    return n.relX += c3, [a2, c3];
  }, [0, 0]);
};
var le = (e, t, n) => {
  const i = e.children[t - 1], o = e.children[t];
  let a2 = i, c3 = i.relX, s2 = o, l = o.relX, p = true;
  for (; a2 && s2; ) {
    a2.bottom > n.lowY && (n = n.next);
    const h = c3 + a2.prelim - (l + s2.prelim) + a2.xSize / 2 + s2.xSize / 2 + a2.spacing(s2);
    (h > 0 || h < 0 && p) && (l += h, ce2(o, h), he(e, t, n.index, h)), p = false;
    const u4 = a2.bottom, g = s2.bottom;
    u4 <= g && (a2 = ue(a2), a2 && (c3 += a2.relX)), u4 >= g && (s2 = de2(s2), s2 && (l += s2.relX));
  }
  !a2 && s2 ? pe(e, t, s2, l) : a2 && !s2 && fe(e, t, a2, c3);
};
var ce2 = (e, t) => {
  e.relX += t, e.lExtRelX += t, e.rExtRelX += t;
};
var he = (e, t, n, i) => {
  const o = e.children[t], a2 = t - n;
  if (a2 > 1) {
    const c3 = i / a2;
    e.children[n + 1].shift += c3, o.shift -= c3, o.change -= i - c3;
  }
};
var de2 = (e) => e.hasChildren ? e.firstChild : e.lThr;
var ue = (e) => e.hasChildren ? e.lastChild : e.rThr;
var pe = (e, t, n, i) => {
  const o = e.firstChild, a2 = o.lExt, c3 = e.children[t];
  a2.lThr = n;
  const s2 = i - n.relX - o.lExtRelX;
  a2.relX += s2, a2.prelim -= s2, o.lExt = c3.lExt, o.lExtRelX = c3.lExtRelX;
};
var fe = (e, t, n, i) => {
  const o = e.children[t], a2 = o.rExt, c3 = e.children[t - 1];
  a2.rThr = n;
  const s2 = i - n.relX - o.rExtRelX;
  a2.relX += s2, a2.prelim -= s2, o.rExt = c3.rExt, o.rExtRelX = c3.rExtRelX;
};
var me = (e) => {
  if (e.hasChildren) {
...
var et = class _et {
  constructor(t, n) {
    this.options = P, this.revokers = [], this.imgCache = {}, this.handleZoom = (i) => {
      ...
      i.preventDefault();
      const o = transform(this.svg.node()), a2 = o.translate(
        -i.deltaX / o.k,
        -i.deltaY / o.k
      );
      this.svg.call(this.zoom.transform, a2);
    }, this.handleClick = (i, o) => {
      let a2 = this.options.toggleRecursively;
      (K2 ? i.metaKey : i.ctrlKey) && (a2 = !a2), this.toggleNode(o.data, a2);
    }, this.svg = t.datum ? t : select_default2(t), this.styleNode = this.svg.append("style"), this.zoom = zoom_default2().filter((i) => this.options.scrollForPan && i.type === "wheel" ? i.ctrlKey && !i.button : (!i.ctrlKey || i.type === "wheel") && !i.button).on("zoom", this.handleZoom), this.setOptions(n), this.state = {
...
`);
  ...
  toggleNode(t, n = false) {
    ...
    n ? walkTree(t, (c3, s2) => {
      ...
      ...t.payload,
      fold: (a2 = t.payload) != null && a2.fold ? 0 : 1
    }, this.renderData(t);
  }
  initializeData(t) {
    let n = 0;
    const { color: i, nodeMinHeight: o, maxWidth: a2, initialExpandLevel: c3 } = this.options, { id: s2 } = this.state, l = O(
      j("div", { className: `markmap-container markmap ${s2}-g` })
    ), p = O(
      j("style", { children: [this.getStyleContent(), xe].join(`
`) })
    );
    document.body.append(l, p);
    const h = a2 ? `--markmap-max-width: ${a2}px` : "";
    let u4 = 0, g = 0;
    walkTree(t, (f, y3, m) => {
      var b, w, z;
      g += 1, f.children = (b = f.children) == null ? void 0 : b.map((E2) => ({ ...E2 })), n += 1;
      const k2 = O(
        j(
          "div",
          {
            ...
            style: h,
            children: j("div", { dangerouslySetInnerHTML: { __html: f.content } })
          }
        )
      );
      l.append(k2), f.state = {
      ...
      const v2 = ((z = f.payload) == null ? void 0 : z.fold) === 2;
      v2 ? u4 += 1 : (u4 || c3 >= 0 && f.state.depth >= c3) && (f.payload = { ...f.payload, fold: 1 }), y3(), v2 && (u4 -= 1), g -= 1;
    });
    const x3 = Array.from(l.childNodes).map(
      (f) => f.firstChild
    );
    this._checkImages(l), x3.forEach((f) => {
      var y3;
      (y3 = f.parentNode) == null || y3.append(f.cloneNode(true));
    }), walkTree(t, (f, y3, m) => {
      var b;
      const k2 = f.state, v2 = k2.el.getBoundingClientRect();
      f.content = k2.el.innerHTML, k2.size = [
        Math.ceil(v2.width) + 1,
        Math.max(Math.ceil(v2.height), o)
      ], k2.key = [(b = m == null ? void 0 : m.state) == null ? void 0 : b.id, k2.id].filter(Boolean).join(".") + // FIXME: find a way to check content hash
      f.content, y3();
    }), l.remove(), p.remove();
  }
  _checkImages(t) {
  ...
  renderData(t) {
    if (!this.state.data)
      return;
    const { spacingHorizontal: n, paddingX: i, spacingVertical: o, autoFit: a2, color: c3 } = this.options, s2 = q({}).children((r) => {
      var d;
    ...
    }).spacing((r, d) => r.parent === d.parent ? o : o * 2), l = s2.hierarchy(this.state.data);
    s2(l);
    const p = l.descendants().reverse(), h = l.links(), u4 = linkHorizontal(), g = min(p, (r) => r.x - r.xSize / 2), x3 = max(p, (r) => r.x + r.xSize / 2), f = min(p, (r) => r.y), y3 = max(p, (r) => r.y + r.ySize - n);
    ...
    const m = t && p.find((r) => r.data === t) || l, k2 = m.data.state.x0 ?? m.x, v2 = m.data.state.y0 ?? m.y, b = this.g.selectAll(
      childSelector("g")
      ...
      "transform",
      (r) => `translate(${v2 + m.ySize - r.ySize},${k2 + m.xSize / 2 - r.xSize})`
    ...
    this.transition(E2).attr(
      "transform",
      (r) => `translate(${r.y},${r.x - r.xSize / 2})`
    );
    const nt = E2.selectAll(
      childSelector("line")
    ).data(
      (r) => [r],
      (r) => r.data.state.key
    ...
    this.transition(nt).attr("x1", -1).attr("x2", (r) => r.ySize - n + 2).attr("y1", (r) => r.xSize).attr("y2", (r) => r.xSize).attr("stroke", (r) => c3(r.data)).attr("stroke-width", W);
    const it = E2.selectAll(
      ...
      (r) => r.append("circle").attr("stroke-width", "1.5").attr("cx", (d) => d.ySize - n).attr("cy", (d) => d.xSize).attr("r", 0).on("click", (d, S) => this.handleClick(d, S)).on("mousedown", D3),
      (r) => r,
      (r) => r.remove()
    );
    this.transition(it).attr("r", 6).attr("cx", (r) => r.ySize - n).attr("cy", (r) => r.xSize).attr("stroke", (r) => c3(r.data)).attr(
      "fill",
      (r) => {
        var d;
        return (d = r.data.payload) != null && d.fold && r.data.children ? c3(r.data) : "#fff";
      }
    );
    const rt = E2.selectAll(
      ...
      (r) => {
        const d = r.append("foreignObject").attr("class", "markmap-foreign").attr("x", i).attr("y", 0).style("opacity", 0).on("mousedown", D3).on("dblclick", D3);
    ...
    const ot = this.g.selectAll(
      ...
      (r) => {
        ...
        return r.insert("path", "g").attr("class", "markmap-link").attr("data-depth", (S) => S.target.data.state.depth).attr("data-path", (S) => S.target.data.state.path).attr("d", u4({ source: d, target: d }));
      },
      (r) => r,
      (r) => {
        const d = [
        ...
        return this.transition(r).attr("d", u4({ source: d, target: d })).remove();
      }
    );
    this.transition(ot).attr("stroke", (r) => c3(r.target.data)).attr("stroke-width", (r) => W(r.target)).attr("d", (r) => {
   ...
   */
  async fit() {
    const t = this.svg.node(), { width: n, height: i } = t.getBoundingClientRect(), { fitRatio: o } = this.options, { minX: a2, maxX: c3, minY: s2, maxY: l } = this.state, p = l - s2, h = c3 - a2, u4 = Math.min(
      n / p * o,
      i / h * o,
      2
    ), g = identity5.translate(
      (n - p * u4) / 2 - s2 * u4,
      (i - h * u4) / 2 - a2 * u4
    ).scale(u4);
  ...
  async ensureView(t, n) {
    var k2;
    const i = (k2 = this.findElement(t)) == null ? void 0 : k2.data;
    if (!i)
      return;
    const o = this.svg.node(), { spacingHorizontal: a2 } = this.options, c3 = o.getBoundingClientRect(), s2 = transform(o), [l, p] = [
      i.y,
      i.y + i.ySize - a2 + 2
    ].map((v2) => v2 * s2.k + s2.x), [h, u4] = [
      i.x - i.xSize / 2,
      i.x + i.xSize / 2
    ].map((v2) => v2 * s2.k + s2.y), g = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0,
      ...n
    }, x3 = [g.left - l, c3.width - g.right - p], f = [g.top - h, c3.height - g.bottom - u4], y3 = x3[0] * x3[1] > 0 ? Y2(x3, Math.abs) / s2.k : 0, m = f[0] * f[1] > 0 ? Y2(f, Math.abs) / s2.k : 0;
    if (y3 || m) {
      const v2 = s2.translate(y3, m);
   ...
   */
  async rescale(t) {
    const n = this.svg.node(), { width: i, height: o } = n.getBoundingClientRect(), a2 = i / 2, c3 = o / 2, s2 = transform(n), l = s2.translate(
      (a2 - s2.x) * (1 - t) / s2.k,
      (c3 - s2.y) * (1 - t) / s2.k
    ).scale(t);
