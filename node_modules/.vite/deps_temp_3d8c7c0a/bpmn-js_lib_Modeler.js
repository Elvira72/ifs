import {
  ...
  translate,
  translate_default
} from "./chunk-R2BZ6JZQ.js";
import {
  isAuxiliaryButton,
  isPrimaryButton as isPrimaryButton2
} from "./chunk-MKD6GFSP.js";
import "./chunk-I34XMBR6.js";
import {
  append,
  attr as attr2,
  classes as classes2,
...
import {
  ...
  roundPoint,
  selfAndAllChildren
} from "./chunk-HIUBAWRT.js";
import {
  getParent,
  isDirectionHorizontal
} from "./chunk-4JO4UBCA.js";
import {
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/scheduler/Scheduler.js
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/scheduler/index.js
...
function _(l3, u3, t4) {
  var i3, r4, o3, e4 = {};
  for (o3 in u3)
    "key" == o3 ? i3 = u3[o3] : "ref" == o3 ? r4 = u3[o3] : e4[o3] = u3[o3];
  if (arguments.length > 2 && (e4.children = arguments.length > 3 ? n.call(arguments, 2) : t4), "function" == typeof l3 && null != l3.defaultProps)
    for (o3 in l3.defaultProps)
      null == e4[o3] && (e4[o3] = l3.defaultProps[o3]);
  return m(l3, e4, i3, r4, null);
}
function m(n3, t4, i3, r4, o3) {
  var e4 = { type: n3, props: t4, key: i3, ref: r4, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: null == o3 ? ++u : o3, __i: -1, __u: 0 };
...
function $() {
  for (var n3, u3, t4, r4, o3, f3, c3, s3 = 1; i.length; )
    i.length > s3 && i.sort(e2), n3 = i.shift(), s3 = i.length, n3.__d && (t4 = void 0, o3 = (r4 = (u3 = n3).__v).__e, f3 = [], c3 = [], u3.__P && ((t4 = d({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(t4), O(u3.__P, t4, r4, u3.__n, u3.__P.namespaceURI, 32 & r4.__u ? [o3] : null, f3, null == o3 ? S(r4) : o3, !!(32 & r4.__u), c3), t4.__v = r4.__v, t4.__.__k[t4.__i] = t4, z(f3, t4, c3), t4.__e != o3 && C(t4)));
  $.__r = 0;
}
function I(n3, l3, u3, t4, i3, r4, o3, e4, f3, c3, s3) {
  var a3, h3, v3, w3, d3, g3, _3 = t4 && t4.__k || y, m4 = l3.length;
  for (f3 = P(u3, l3, _3, f3, m4), a3 = 0; a3 < m4; a3++)
    null != (v3 = u3.__k[a3]) && (h3 = -1 == v3.__i ? p : _3[v3.__i] || p, v3.__i = a3, g3 = O(n3, v3, h3, i3, r4, o3, e4, f3, c3, s3), w3 = v3.__e, v3.ref && h3.ref != v3.ref && (h3.ref && q(h3.ref, null, v3), s3.push(v3.ref, v3.__c || w3, v3)), null == d3 && null != w3 && (d3 = w3), 4 & v3.__u || h3.__k === v3.__k ? f3 = A(v3, f3, n3) : "function" == typeof v3.type && void 0 !== g3 ? f3 = g3 : w3 && (f3 = w3.nextSibling), v3.__u &= -7);
  return u3.__e = d3, f3;
}
function P(n3, l3, u3, t4, i3) {
  var r4, o3, e4, f3, c3, s3 = u3.length, a3 = s3, h3 = 0;
  for (n3.__k = new Array(i3), r4 = 0; r4 < i3; r4++)
    null != (o3 = l3[r4]) && "boolean" != typeof o3 && "function" != typeof o3 ? (f3 = r4 + h3, (o3 = n3.__k[r4] = "string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? m(null, o3, null, null, null) : w(o3) ? m(k, { children: o3 }, null, null, null) : null == o3.constructor && o3.__b > 0 ? m(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : o3).__ = n3, o3.__b = n3.__b + 1, e4 = null, -1 != (c3 = o3.__i = L(o3, u3, f3, a3)) && (a3--, (e4 = u3[c3]) && (e4.__u |= 2)), null == e4 || null == e4.__v ? (-1 == c3 && (i3 > s3 ? h3-- : i3 < s3 && h3++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f3 && (c3 == f3 - 1 ? h3-- : c3 == f3 + 1 ? h3++ : (c3 > f3 ? h3-- : h3++, o3.__u |= 4))) : n3.__k[r4] = null;
  if (a3)
    for (r4 = 0; r4 < s3; r4++)
      null != (e4 = u3[r4]) && 0 == (2 & e4.__u) && (e4.__e == t4 && (t4 = S(e4)), B(e4, e4));
  return t4;
}
function A(n3, l3, u3) {
  var t4, i3;
  if ("function" == typeof n3.type) {
    for (t4 = n3.__k, i3 = 0; t4 && i3 < t4.length; i3++)
      t4[i3] && (t4[i3].__ = n3, l3 = A(t4[i3], l3, u3));
    return l3;
  }
...
function L(n3, l3, u3, t4) {
  var i3, r4, o3 = n3.key, e4 = n3.type, f3 = l3[u3];
  if (null === f3 && null == n3.key || f3 && o3 == f3.key && e4 == f3.type && 0 == (2 & f3.__u))
    return u3;
  if (t4 > (null != f3 && 0 == (2 & f3.__u) ? 1 : 0))
    for (i3 = u3 - 1, r4 = u3 + 1; i3 >= 0 || r4 < l3.length; ) {
      if (i3 >= 0) {
        if ((f3 = l3[i3]) && 0 == (2 & f3.__u) && o3 == f3.key && e4 == f3.type)
          return i3;
        i3--;
      }
      if (r4 < l3.length) {
        if ((f3 = l3[r4]) && 0 == (2 & f3.__u) && o3 == f3.key && e4 == f3.type)
          return r4;
        r4++;
      }
    }
...
function j(n3, l3, u3, t4, i3) {
  ...
  n:
    if ("style" == l3)
      ...
      r4 = l3 != (l3 = l3.replace(f, "$1")), l3 = l3.toLowerCase() in n3 || "onFocusOut" == l3 || "onFocusIn" == l3 ? l3.toLowerCase().slice(2) : l3.slice(2), n3.l || (n3.l = {}), n3.l[l3 + r4] = u3, u3 ? t4 ? u3.u = t4.u : (u3.u = c, n3.addEventListener(l3, r4 ? a : s, r4)) : n3.removeEventListener(l3, r4 ? a : s, r4);
    else {
...
function O(n3, u3, t4, i3, r4, o3, e4, f3, c3, s3) {
  var a3, h3, p3, y3, v3, _3, m4, b2, S2, C3, M2, $2, P3, A3, H, L2, T3, j3 = u3.type;
    ...
    if ("function" == typeof j3)
      try {
        if (b2 = u3.props, S2 = "prototype" in j3 && j3.prototype.render, C3 = (a3 = j3.contextType) && i3[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i3, t4.__c ? m4 = (h3 = u3.__c = t4.__c).__ = h3.__E : (S2 ? u3.__c = h3 = new j3(b2, M2) : (u3.__c = h3 = new x(b2, M2), h3.constructor = j3, h3.render = D), C3 && C3.sub(h3), h3.props = b2, h3.state || (h3.state = {}), h3.context = M2, h3.__n = i3, p3 = h3.__d = true, h3.__h = [], h3._sb = []), S2 && null == h3.__s && (h3.__s = h3.state), S2 && null != j3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, j3.getDerivedStateFromProps(b2, h3.__s))), y3 = h3.props, v3 = h3.state, h3.__v = u3, p3)
          ...
          if (S2 && null == j3.getDerivedStateFromProps && b2 !== y3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(b2, M2), !h3.__e && null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(b2, h3.__s, M2) || u3.__v == t4.__v) {
        ...
        if (h3.context = M2, h3.props = b2, h3.__P = n3, h3.__e = false, P3 = l.__r, A3 = 0, S2) {
        ...
        h3.state = h3.__s, null != h3.getChildContext && (i3 = d(d({}, i3), h3.getChildContext())), S2 && !p3 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(y3, v3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = N(a3.props.children)), f3 = I(n3, w(L2) ? L2 : [L2], u3, t4, i3, r4, o3, e4, f3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && e4.push(h3), m4 && (h3.__E = h3.__ = null);
      } catch (n4) {
        if (u3.__v = null, c3 || null != o3)
          ...
          u3.__e = t4.__e, u3.__k = t4.__k;
        l.__e(n4, u3, t4);
      }
    else
      null == o3 && u3.__v == t4.__v ? (u3.__k = t4.__k, u3.__e = t4.__e) : f3 = u3.__e = V(t4.__e, u3, t4, i3, r4, o3, e4, c3, s3);
...
function V(u3, t4, i3, r4, o3, e4, f3, c3, s3) {
  var a3, h3, y3, v3, d3, _3, m4, b2 = i3.props, k3 = t4.props, x3 = t4.type;
  if ("svg" == x3 ? o3 = "http://www.w3.org/2000/svg" : "math" == x3 ? o3 = "http://www.w3.org/1998/Math/MathML" : o3 || (o3 = "http://www.w3.org/1999/xhtml"), null != e4) {
    for (a3 = 0; a3 < e4.length; a3++)
      if ((d3 = e4[a3]) && "setAttribute" in d3 == !!x3 && (x3 ? d3.localName == x3 : 3 == d3.nodeType)) {
        u3 = d3, e4[a3] = null;
        break;
      }
  }
  if (null == u3) {
    ...
    u3 = document.createElementNS(o3, x3, k3.is && k3), c3 && (l.__m && l.__m(t4, e4), c3 = false), e4 = null;
  }
  if (null == x3)
    b2 === k3 || c3 && u3.data == k3 || (u3.data = k3);
  else {
    if (e4 = e4 && n.call(u3.childNodes), b2 = i3.props || p, !c3 && null != e4)
    ...
    for (a3 in k3)
      d3 = k3[a3], "children" == a3 ? v3 = d3 : "dangerouslySetInnerHTML" == a3 ? h3 = d3 : "value" == a3 ? _3 = d3 : "checked" == a3 ? m4 = d3 : c3 && "function" != typeof d3 || b2[a3] === d3 || j(u3, a3, d3, b2[a3], o3);
    if (h3)
      c3 || y3 && (h3.__html == y3.__html || h3.__html == u3.innerHTML) || (u3.innerHTML = h3.__html), t4.__k = [];
    else if (y3 && (u3.innerHTML = ""), I("template" == t4.type ? u3.content : u3, w(v3) ? v3 : [v3], t4, i3, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o3, e4, f3, e4 ? e4[0] : i3.__k && S(i3, 0), c3, s3), null != e4)
      for (a3 = e4.length; a3--; )
        g(e4[a3]);
    c3 || (a3 = "value", "progress" == x3 && null == _3 ? u3.removeAttribute("value") : null != _3 && (_3 !== u3[a3] || "progress" == x3 && !_3 || "option" == x3 && _3 != b2[a3]) && j(u3, a3, _3, b2[a3], o3), a3 = "checked", null != m4 && m4 != u3[a3] && j(u3, a3, m4, b2[a3], o3));
  }
  return u3;
}
function q(n3, u3, t4) {
...
function B(n3, u3, t4) {
  ...
  if (i3 = n3.__k)
    for (r4 = 0; r4 < i3.length; r4++)
      i3[r4] && B(i3[r4], u3, t4 || "function" != typeof n3.type);
...
function E(u3, t4, i3) {
  var r4, o3, e4, f3;
  t4 == document && (t4 = document.documentElement), l.__ && l.__(u3, t4), o3 = (r4 = "function" == typeof i3) ? null : i3 && i3.__k || t4.__k, e4 = [], f3 = [], O(t4, u3 = (!r4 && i3 || t4).__k = _(k, null, [u3]), o3 || p, p, t4.namespaceURI, !r4 && i3 ? [i3] : o3 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e4, !r4 && i3 ? i3 : o3 ? o3.__e : t4.firstChild, r4, f3), z(e4, u3, f3);
}
n = y.slice, l = { __e: function(n3, l3, u3, t4) {
  for (var i3, r4, o3; l3 = l3.__; )
    if ((i3 = l3.__c) && !i3.__)
      try {
        if ((r4 = i3.constructor) && null != r4.getDerivedStateFromError && (i3.setState(r4.getDerivedStateFromError(n3)), o3 = i3.__d), null != i3.componentDidCatch && (i3.componentDidCatch(n3, t4 || {}), o3 = i3.__d), o3)
          return i3.__E = i3;
      } catch (l4) {
        n3 = l4;
      }
...
}, x.prototype.render = k, i = [], o = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, e2 = function(n3, l3) {
  ...
  return r4 || (r4 = /* @__PURE__ */ new Map(), t2.set(this, r4)), (r4 = n2(this, r4.get(s3) || (r4.set(s3, r4 = function(n3) {
    for (var t4, s4, r5 = 1, e4 = "", u3 = "", h3 = [0], p3 = function(n4) {
      ...
      for (var l3 = 0; l3 < n3[a3].length; l3++)
        t4 = n3[a3][l3], 1 === r5 ? "<" === t4 ? (p3(), h3 = [h3], r5 = 3) : e4 += t4 : 4 === r5 ? "--" === e4 && ">" === t4 ? (r5 = 1, e4 = "") : e4 = t4 + e4[0] : u3 ? t4 === u3 ? u3 = "" : e4 += t4 : '"' === t4 || "'" === t4 ? u3 = t4 : ">" === t4 ? (p3(), r5 = 1) : r5 && ("=" === t4 ? (r5 = 5, s4 = e4, e4 = "") : "/" === t4 && (r5 < 5 || ">" === n3[a3][l3 + 1]) ? (p3(), 3 === r5 && (h3 = h3[0]), r5 = h3, (h3 = h3[0]).push(2, 0, r5), r5 = 0) : " " === t4 || "	" === t4 || "\n" === t4 || "\r" === t4 ? (p3(), r5 = 2) : e4 += t4), 3 === r5 && "!--" === e4 && (r5 = 4, h3 = h3[0]);
    }
    return p3(), h3;
...
function clsx() {
  for (var e4, t4, f3 = 0, n3 = "", o3 = arguments.length; f3 < o3; f3++)
    (e4 = arguments[f3]) && (t4 = r3(e4)) && (n3 && (n3 += " "), n3 += t4);
  return n3;
}
var clsx_default = clsx;

// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/popup-menu/PopupMenuHeader.js
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/popup-menu/PopupMenuItem.js
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/popup-menu/PopupMenuList.js
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/popup-menu/PopupMenuComponent.js
...
function getConnectedDistance(source, hints) {
  ...
  function getDistance4(a3, b2) {
    if (direction === "n") {
      if (reference === "start") {
        return asTRBL(a3).top - asTRBL(b2).bottom;
      } else if (reference === "center") {
        return asTRBL(a3).top - getMid(b2).y;
      } else {
        return asTRBL(a3).top - asTRBL(b2).top;
      }
    } else if (direction === "w") {
      if (reference === "start") {
        return asTRBL(a3).left - asTRBL(b2).right;
      } else if (reference === "center") {
        return asTRBL(a3).left - getMid(b2).x;
      } else {
        return asTRBL(a3).left - asTRBL(b2).left;
      }
    } else if (direction === "s") {
      if (reference === "start") {
        return asTRBL(b2).top - asTRBL(a3).bottom;
      } else if (reference === "center") {
        return getMid(b2).y - asTRBL(a3).bottom;
      } else {
        return asTRBL(b2).bottom - asTRBL(a3).bottom;
      }
    } else {
      if (reference === "start") {
        return asTRBL(b2).left - asTRBL(a3).right;
      } else if (reference === "center") {
        return getMid(b2).x - asTRBL(a3).right;
      } else {
        return asTRBL(b2).right - asTRBL(a3).right;
      }
    }
  }
...
function getPathIntersection(waypoints, reference) {
  ...
  var a3 = intersections[0], b2 = intersections[intersections.length - 1], idx;
  if (!a3) {
    return null;
  }
  if (a3 !== b2) {
    if (a3.segment2 !== b2.segment2) {
      idx = max(a3.segment2, b2.segment2) - 1;
      return {
        point: waypoints[idx],
        bendpoint: true,
        index: idx
    ...
    return {
      point: {
        x: round2(a3.x + b2.x) / 2,
        y: round2(a3.y + b2.y) / 2
      },
      index: a3.segment2
    };
  }
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/bendpoints/GeometricUtil.js
...
function solveLambaSystem(a3, b2, c3) {
  var system = [
    { n: a3[0] - c3[0], lambda: b2[0] },
    { n: a3[1] - c3[1], lambda: b2[1] }
  ];
  var n3 = system[0].n * b2[0] + system[1].n * b2[1], l3 = system[0].lambda * b2[0] + system[1].lambda * b2[1];
  return -n3 / l3;
}
function perpendicularFoot(point, line) {
  var a3 = line[0], b2 = line[1];
  var bd = { x: b2.x - a3.x, y: b2.y - a3.y };
...
function BendpointSnapping(eventBus) {
  function snapTo2(values2, value) {
    if (isArray(values2)) {
      ...
      while (i3--)
        if (abs2(values2[i3] - value) <= TOLERANCE) {
          return values2[i3];
        }
    } else {
      values2 = +values2;
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/complex-preview/ComplexPreview.js
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/complex-preview/index.js
...
function lineIntersect(l1s, l1e, l2s, l2e) {
  var denominator, a3, b2, c3, numerator;
  ...
  a3 = l1s.y - l2s.y;
  b2 = l1s.x - l2s.x;
  numerator = (l2e.x - l2s.x) * a3 - (l2e.y - l2s.y) * b2;
...
function isSameOrganization(a3, b2) {
  var parentA = getOrganizationalParent(a3), parentB = getOrganizationalParent(b2);
...
function isSameScope(a3, b2) {
  var scopeParentA = getScopeParent(a3), scopeParentB = getScopeParent(b2);
...
// ../node_modules/bpmn-js/node_modules/diagram-js/lib/features/replace/ReplaceSelectionBehavior.js
...
function getSegmentBendpoints(a3, b2, directions2) {
  var orientation = getOrientation(b2, a3, POINT_ORIENTATION_PADDING);
  var startDirection = directions2.split(":")[0];
  var xmid = round10((b2.x - a3.x) / 2 + a3.x), ymid = round10((b2.y - a3.y) / 2 + a3.y);
...
function getStartSegment(a3, b2, directions2) {
  return getSegmentBendpoints(a3, b2, directions2);
}
function getEndSegment(a3, b2, directions2) {
  var invertedSegment = getSegmentBendpoints(b2, a3, invertDirections(directions2));
  return {
...
function getSimpleBendpoints(a3, b2, directions2) {
  var xmid = round10((b2.x - a3.x) / 2 + a3.x), ymid = round10((b2.y - a3.y) / 2 + a3.y);
  if (directions2 === "h:v") {
    return [{ x: b2.x, y: a3.y }];
  }
  if (directions2 === "v:h") {
    return [{ x: a3.x, y: b2.y }];
  }
  if (directions2 === "h:h") {
    return [
      { x: xmid, y: a3.y },
...
function getBendpoints(a3, b2, directions2) {
  ...
  if (isExplicitDirections(directions2)) {
    var startSegment = getStartSegment(a3, b2, directions2), endSegment = getEndSegment(a3, b2, directions2), midSegment = getMidSegment(startSegment, endSegment);
    return [].concat(
  ...
  return getSimpleBendpoints(a3, b2, directions2);
}
function connectPoints(a3, b2, directions2) {
  var points = getBendpoints(a3, b2, directions2);
  points.unshift(a3);
  points.push(b2);
...
function isInRange(axis, a3, b2) {
  var size2 = {
    x: "width",
    y: "height"
  };
  return inRange(a3[axis], b2[axis], b2[axis] + b2[size2[axis]]);
}
...
function _tryRepairConnectionSide(moved, other, newDocking, points) {
  ...
  function removeOverlapping(points2, a3, b2) {
    var i3;
    for (i3 = points2.length - 2; i3 !== 0; i3--) {
      if (pointInRect(points2[i3], a3, INTERSECTION_THRESHOLD2) || pointInRect(points2[i3], b2, INTERSECTION_THRESHOLD2)) {
...
function isOppositeOrientation(a3, b2) {
  return oppositeOrientationMapping[a3] === b2;
}
function isOppositeHorizontalOrientation(a3, b2) {
  var horizontalOrientation = getHorizontalOrientation(a3);
  var oppositeHorizontalOrientation = oppositeOrientationMapping[horizontalOrientation];
  return b2.indexOf(oppositeHorizontalOrientation) !== -1;
}
function isOppositeVerticalOrientation(a3, b2) {
...
function areCloseOnAxis(axis, a3, b2, threshold) {
  return Math.abs(a3[axis] - b2[axis]) < threshold;
}
...
function drawPath(waypoints, cornerRadius) {
  ...
  for (let i3 = 1; i3 < pointCount; i3++) {
    ...
    const effectiveRadius = Math.min(
      cornerRadius,
      vectorLength2(point.x - pointBefore.x, point.y - pointBefore.y),
      vectorLength2(pointAfter.x - point.x, pointAfter.y - point.y)
    );
    if (!effectiveRadius) {
      path.push(lineTo(point));
      continue;
...
function getPointAtLength(start, end, length2) {
  ...
  const totalLength = vectorLength2(deltaX, deltaY);
...
function vectorLength2(x3, y3) {
  return Math.sqrt(Math.pow(x3, 2) + Math.pow(y3, 2));
}
function createLine2(points, attrs, radius) {
  if (isNumber(attrs)) {
    radius = attrs;
    attrs = null;
  }
...
function InteractionEvents(eventBus, elementRegistry, styles) {
  ...
  eventBus.on([
    "shape.changed",
    "connection.changed"
  ], LOW_PRIORITY18, function(event2) {
    var element = event2.element, gfx = event2.gfx;
    eventBus.fire("interactionEvents.updateHit", { element, gfx });
  });
  eventBus.on("interactionEvents.createHit", LOW_PRIORITY18, function(event2) {
    var element = event2.element, gfx = event2.gfx;
...
function DistributeElementsMenuProvider(popupMenu, distributeElements, translate2, rules) {
  ...
  this._popupMenu = popupMenu;
  this._rules = rules;
  popupMenu.registerProvider("align-elements", LOW_PRIORITY19, this);
}
...
var LOW_PRIORITY20 = 800;
function GridSnapping(elementRegistry, eventBus, config) {
  var active = !config || config.active !== false;
  this._eventBus = eventBus;
  var self2 = this;
  eventBus.on("diagram.init", LOW_PRIORITY20, function() {
...
function ResizePreview(eventBus, canvas, previewSupport) {
  ...
  eventBus.on("resize.move", LOW_PRIORITY21, function(event2) {
...
BpmnSearchProvider.prototype.find = function(pattern) {
  ...
  return elements.reduce(function(results, element) {
    ...
    return compareTokens(a3.primaryTokens, b2.primaryTokens) || compareTokens(a3.secondaryTokens, b2.secondaryTokens) || compareStrings(getLabel(a3.element), getLabel(b2.element)) || compareStrings(a3.element.id, b2.element.id);
  }).map(function(result) {
    return {
      element: result.element,
