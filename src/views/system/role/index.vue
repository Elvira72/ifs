<template>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column :width="300" align="center" label="操作">
        <template #default="scope">
          ...
          'system:permission:assign-role-product',
          'system:permission:assign-role-table-column'
        ]"
            >
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <!-- 数据权限 -->
                  <el-dropdown-item
                    command="openDataPermissionForm"
                  ...
                  <el-dropdown-item
                    ...
                    v-if="checkPermi(['system:permission:assign-role-product'])"
                  >
                  ...
                  <el-dropdown-item
                    ...
                    v-if="checkPermi(['system:permission:assign-role-table-column'])"
                  >
  ...
  <!-- 表单弹窗：产品权限 -->
  <RoleAssignProductForm ref="assignProductFormRef" @success="getList" />
  <!-- 表单弹窗：字段权限 -->
  <RoleAssignFieldForm ref="assignFieldFormRef" @success="getList" />
...
import RoleAssignProductForm from './RoleAssignProductForm.vue'
import RoleAssignFieldForm from './RoleAssignFieldForm.vue'
...
const openAssignProductForm = async (row: RoleApi.RoleVO) => {
  assignProductFormRef.value.open(row)
}

/** 字段权限操作 */
const assignFieldFormRef = ref()
const openAssignFieldForm = async (row: RoleApi.RoleVO) => {
  assignFieldFormRef.value.open(row)
}
